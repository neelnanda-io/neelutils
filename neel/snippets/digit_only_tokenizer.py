...
print(new_tokenizer)
new_tokenizer.add_special_tokens({'eos_token':eos_token, 
                                  'bos_token':bos_token,
                                 'pad_token':pad_token})
...
print(new_tokenizer_2.batch_decode(new_tokenizer_2.encode("123+ 32563872+ 39872398743+39 84 2y39"), clean_up_tokenization_spaces=False))
